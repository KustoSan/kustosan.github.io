...
$(document).ready(function () {
	...
	if (user != undefined) {
		...
		$('.gprogress').html(user + "'s followers anime compatibility")
			    ...
			    success: function (data){
		        	...
		        	jQuery.each(data.users, function (a, val) {
		  				...
		  				$.getJSON('https://hbird-cmp-node.herokuapp.com/compatibility/anime?user1=' + user + '&user2=' + val.id + '&callback=asd', function (data) {
		            		...
		            		$('#members').append('<tr id="ded"><td class="countTd"><b></b></td><td><a style="color:#428bca;" href="https://hummingbird.me/users/' + val.id + '" target="_blank"</a>' + val.id + '</td><td>' + data.percent + '</td><td>Stalker-kun</td></tr>');
